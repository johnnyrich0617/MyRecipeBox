...
public class Ingredient {
    ...
    //Number of calories per UOM (Cup, Tblspoon, Teaspoon, oz, lbs..)
     ...
     * @throws jrichardson.snhu.myrecipebox.exception.RecipeException
     */
    public void setIngredientName (String ingredientName) throws RecipeException {
     ...
     * @throws jrichardson.snhu.myrecipebox.exception.RecipeException
     */
    public void setAmountOfIngredient(float amountOfIngredient) throws RecipeException {
    ...
    public String toString() {
        return "Ingredient{\n" 
                ...
                + "\tcaloriesPerUOM     =" + caloriesPerUOM + ",\n" 
                + "\t totalCalories     =" + totalCalories + "\n\t},";
    }
    
    /**
     * Calculate the total calories for this Ingredient
     * @param caloriesPerUOM Number of calories per unit of measure
     * @param totalAmount Total amount of this Ingredient
     * @link (jrichardson.snhu.myrecipebox.utils.RecipeUtils)
     */
